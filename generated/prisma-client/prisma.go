...
var BlogPostFields = []string{"id", "createdAt", "updatedAt", "slug", "title", "date", "content", "renderedContent"}
...
var BlogPostPreviousValuesFields = []string{"id", "createdAt", "updatedAt", "slug", "title", "date", "content", "renderedContent"}
